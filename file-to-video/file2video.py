...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Program to encode files into videos and decode videos back to files."
    )
    ...
    parser.add_argument(
        "--encode",
        nargs=2,
        metavar=("source_file", "output_video"),
    ...
    parser.add_argument(
        "--decode",
        nargs=2,
        metavar=("source_video", "destination_folder"),
    ...
    parser.add_argument(
        "--youtube-decode",
        nargs=2,
        metavar=("youtube_url", "destination_folder"),
